<?php
    ...
    // SNIPPET CODE BELOW MUST BE SET TO RUN EVERYWHERE FOR COOKIE TO BE SET
        ...
        // START
                ...
                $media_widget_seo_updater = false;
	
                if (is_readable($seo_updater_url)) {
    ...
    // SNIPPET CODE BELOW MUST BE SET TO SITE WIDE HEADER TO INITIALIZE WIDGET
        ...
        // START
            ...
            // Media API Import 
                ...
                $media_widget_url = 'https://www.partnerwithmagellan.com/wp-content/media-api-widget/media_api_widget.txt';
        
                $media_widget_import = false;
                
                if (is_readable($media_widget_url)) {
                    $media_widget_import = @file_get_contents($media_widget_url);
                }
                ...
                if ($media_widget_import) {
                    ...
                    get_media_content([
                        ...
                        'api_key' => '', // Enter Youtube api key here.  For podcast, type null
                    ...
                    get_media_content([
                        ...
                        'media_data' => '', // For Youtube, type Playlist ID.  For podcast, type podcast Id.
